...
<tr><td> <em>Generated: </em> 6/19/2022 9:21:07 PM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-450-M22/it202-javascript-and-css-challenge/grade/bg339" target="_blank">Grading</a></td></tr></table>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98499966/174507477-6b1f034e-ca80-44e8-8391-d95141502cd0.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Homepage<br></p>
</td></tr>
<tr><td><img width="768px" src="https://user-images.githubusercontent.com/98499966/174507533-29a0da23-62b0-4903-a97a-5df1b04875b3.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Login<br></p>
</td></tr>
<tr><td><img width="768px" src="https://user-images.githubusercontent.com/98499966/174507578-cfdcd76c-317c-46b2-9218-363c2dda640d.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Register<br></p>
</td></tr>
<tr><td><img width="768px" src="https://user-images.githubusercontent.com/98499966/174507631-61facc38-4d7c-4891-9df7-273fab0a8fc2.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Profile<br></p>
</td></tr>
<tr><td><img width="768px" src="https://user-images.githubusercontent.com/98499966/174507691-16489890-b306-49e3-b001-e60000d5451d.png"/></td></tr>
...
<tr><td> <em>Response:</em> <p>Used nav li to set display to inline.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 2: </em> Briefly explain how you remove the navigation list item markers</td></tr>
<tr><td> <em>Response:</em> <p>Due to setting the display to inline, the markers were also removed.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 3: </em> Briefly explain how you gave the navigation a background</td></tr>
<tr><td> <em>Response:</em> <p>I used background-color in my style script<br></p><br></td></tr>
...
<tr><td> <em>Response:</em> <p><sub>i used nav li:hover and used background-color to set it to a different<br>color than the background color&nbsp;</sub><br></p><br></td></tr>
<tr><td> <em>Sub-Task 5: </em> Briefly explain how you changed the challenge list bullet points to checkmarks (✓)</td></tr>
<tr><td> <em>Response:</em> <p>I accidentally used something other than checkmarks. I will accept the points taken<br>off. Essentially, I would have set li list-style to non to remove bullet<br>points and would have then used li::before to set the value to the<br>checkmark characters \2714\0020 which I found online<br></p><br></td></tr>
<tr><td> <em>Sub-Task 6: </em> Briefly explain how you made the first character of the h1 tags and anchor tags uppercased</td></tr>
<tr><td> <em>Response:</em> <p>i used text transform uppercase when i should have used capitalize.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 7: </em> Briefly explain/describe your custom styling of your choice</td></tr>
<tr><td> <em>Response:</em> <p>I added a font family for a different look, gave the text of<br>the list a red color, and also changed the hover color to a<br>different color. I also changed font weight to differentiate the text.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 8: </em> Briefly explain how the styling for the challenge list doesn't impact the navigation list</td></tr>
<tr><td> <em>Response:</em> <p>it doesnt affect it since we used different selectors throughout our code<br></p><br></td></tr>
<tr><td> <em>Sub-Task 9: </em> Briefly explain how you updated the content of the h1 tag with the link text</td></tr>
<tr><td> <em>Response:</em> <p>I found all anchors using document.queryselector(&#39;a&#39;). I then looped through the list created<br>by using this line of code by using a foreach. Added an addEventListener<br>to each element that listens for clicks with the function getCurrentSelection. When the<br>a anchor is clicked, it calls getCurrentSelectio which updates the page.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 10: </em> Briefly explain how you updated the content of the title tag with the link text</td></tr>
<tr><td> <em>Response:</em> <p>Same as h1 tags<br></p><br></td></tr>
</table></td></tr>
...
<tr><td> <em>Response:</em> <p>no difficulties, just simple mistakes that could have been corrected but I had<br>no time.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 2: </em> Add a link to your pull request (hw branch to dev only)</td></tr>
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://github.com/bg339/IT202Summer/pull/6">https://github.com/bg339/IT202Summer/pull/6</a> </td></tr>
<tr><td>Not provided</td></tr>
<tr><td> <em>Sub-Task 3: </em> Add a link to your solution html file from prod (again you can assume the url at this point)</td></tr>
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://bg339-prod.herokuapp.com/M3/challenge.html">https://bg339-prod.herokuapp.com/M3/challenge.html</a> </td></tr>
</table></td></tr>
<table><tr><td><em>Grading Link: </em><a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-450-M22/it202-javascript-and-css-challenge/grade/bg339" target="_blank">Grading</a></td></tr></table>